...
# Commands to be run
commands = [
    ['/usr/bin/time', '-v', './main', '-m', './10k_genomic/4POM_Normal.ttl', '-o', 'res', '-d', '-t', "-a", "-p", "0.05", "-r", "NA"],
    ['/usr/bin/time', '-v', './main', '-m', './10k_genomic/5ORM.ttl', '-o', 'res', '-d', '-t', "-a", "-p", "0.05", "-r", "NA"],
    ['/usr/bin/time', '-v', './main', '-m', './10k_genomic/5OJM.ttl', '-o', 'res', '-d', '-t', "-a", "-p", "0.05", "-r", "NA"],    
    ['/usr/bin/time', '-v', './main', '-m', './100k_genomic/4POM_Normal.ttl', '-o', 'res', '-d', '-t', "-a", "-p", "0.05", "-r", "NA"],
    ['/usr/bin/time', '-v', './main', '-m', './100k_genomic/5ORM.ttl', '-o', 'res', '-d', '-t', "-a", "-p", "0.05", "-r", "NA"],
    ['/usr/bin/time', '-v', './main', '-m', './100k_genomic/5OJM.ttl', '-o', 'res', '-d', '-t', "-a", "-p", "0.05", "-r", "NA"], 
    ['/usr/bin/time', '-v', './main', '-m', './1M_genomic/4POM_Normal.ttl', '-o', 'res', '-d', '-t', "-a", "-p", "0.05", "-r", "NA"],
    ['/usr/bin/time', '-v', './main', '-m', './1M_genomic/5ORM.ttl', '-o', 'res', '-d', '-t', "-a", "-p", "0.05", "-r", "NA"],
    ['/usr/bin/time', '-v', './main', '-m', './1M_genomic/5OJM.ttl', '-o', 'res', '-d', '-t', "-a", "-p", "0.05", "-r", "NA"], 
]

with open('results_flex.txt', 'w') as file:
    with open('results_flex.csv', 'w') as file2:
