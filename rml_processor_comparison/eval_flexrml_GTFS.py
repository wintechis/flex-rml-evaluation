...
# Commands to be run
commands = [
    ['/usr/bin/time', '-v', './main', '-m', './GTFS_10/mapping.nt', '-o', 'res', '-d', '-t', "-a", "-p", "0.05"],
    ['/usr/bin/time', '-v', './main', '-m', './GTFS_100/mapping.nt', '-o', 'res', '-d', '-t', "-a", "-p", "0.05"],
    ['/usr/bin/time', '-v', './main', '-m', './GTFS_500/mapping.nt', '-o', 'res', '-d', '-t', "-a", "-p", "0.05"],    
]

with open('result_flexrml_GTFS.txt', 'w') as file:
    with open('result_flexrml_GTFS.csv', 'w') as file2:
